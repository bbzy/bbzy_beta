...
void _test_type_function() {
    ...
    static_assert(
            std::is_same<GetFunPW<int (TestC::*)(int, long, short)>, TypeWrapper<TestC *, int, long, short>>::value,
            "");
    ...
    static_assert(IsMemberFunction<int (TestC::* *&&)() const>::value == false, "");
    static_assert(
            IsMemberFunction<int (TestC::* *&&)(int, int &, int &&, int *, int **, int **&&) const>::value == false,
            "");
    static_assert(IsMemberFunction<int (TestC::* **)() const>::value == false, "");
    static_assert(
            IsMemberFunction<int (TestC::* **)(int, int &, int &&, int *, int **, int **&&) const>::value == false, "");
    ...
    static_assert(
            std::is_same<ChFuncPT<int (TestC::*)(int, int) const, long, long>, int (TestC::*)(long, long) const>::value,
            "");
}
